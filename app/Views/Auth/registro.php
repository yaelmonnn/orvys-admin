<div class="container-fluid main-container">
        <div class="row content-row justify-content-center align-items-center">
            <div class="col-lg-4 col-md-12 img-logo">
                <img src="<?=base_url('assets/images/logo.jpeg');?>" alt="Logo futurista" class="shadow">
            </div>
                    ...
                    <form action="#" method="post" id="form-registro">
                        <div class="row mb-3-custom">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label for="nombre" class="form-label small">Nombre completo <i class="fa-solid fa-user ms-1"></i><span class="ms-2 obligatorio">*Obligatorio*</span></label>
                                <input type="text" class="form-control form-control-sm" id="nombre" name="nombre" placeholder="Ingrese su nombre completo" required>
                            </div>
                            <div class="col-md-6">
                                <label for="telefono" class="form-label small">Teléfono <i class="fa-solid fa-phone ms-1"></i><span class="ms-2 obligatorio">*Obligatorio*</span></label>
                        ...
                        <div class="mb-3-custom">
                            <label for="email" class="form-label small">Email <i class="fa-solid fa-envelope ms-1"></i><span class="ms-2 obligatorio">*Obligatorio*</span></label>
                        ...
                        <div class="row mb-3-custom">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label for="password" class="form-label small">Contraseña <i class="fa-solid fa-lock ms-1"></i><span class="ms-2 obligatorio">*Obligatorio*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="confirm_password" class="form-label small">Confirmar contraseña <i class="fa-solid fa-lock ms-1"></i><span class="ms-2 obligatorio">*Obligatorio*</span></label>
                                <div class="input-group input-group-sm">
